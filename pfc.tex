...
\begin{document}
  ...
  %
        ...
        %\include{002_certificado}
        \thispagestyle{empty}     % No number page, headings...

        \include{003_resumen}
        \thispagestyle{empty}     % No number page, headings...

        \include{004_palabras_clave}
        \thispagestyle{empty}     % No number page, headings...

        \include{005_agradecementos}
        \thispagestyle{empty}     % No number page, headings...

        \include{006_cc_licence}
        \thispagestyle{empty}     % No number page, headings...
  ...
  % MAINMATTER: El contenido, cap?ulo a cap?ulo, de la memoria del PFC.
        ...
        \include{020_estado_do_arte}
        \include{030_fundamentos_tecnoloxicos}
        \include{040_metodoloxia}
        \include{050_planificacion_seguimento}
        \include{060_analise_requisitos}
        \include{070_desarrollo}
        \include{080_conclusions}

  % INCLUIMOS LOS APÉNDICES...
        \appendix
        \include{A010_escollerlicencia}
